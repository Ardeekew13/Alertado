...
const ViewComplaintDetailsAdmin = ({ route }) => {
  ...
  const deleteComplaint = async () => {
    try {
      ...
      const complaintRef = doc(firestore, 'Complaint', complaint.transactionId);
      await firestore.delete(complaintRef);
    ...
    <ScrollView style={styles.flexContainer}>
      <View style={styles.flexContainer}>
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.largeText}>#{complaint.transactionId}</Text>
          ...
          >
            {mapReady && (
              <Marker
                ...
                description={`#${complaint.transactionId}`}
              />
            )}
